...
#! \end{center}
#! @EndLatexOnly
#! The the additive closure of a disconnected category then extracts the blocks for the below right
#! list of matrices.
#! @BeginLatexOnly
#! \begin{center}
#!      \begin{array}{c|ccc}
...
#! 
#! If $C$ is skeletal, then the the additive closure of a disconnected category is also skeletal.
